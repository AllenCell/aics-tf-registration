...
[![Build Status](https://github.com/mfs4rd/aics_tf_registration/workflows/Build%20Master/badge.svg)](https://github.com/mfs4rd/aics_tf_registration/actions)
[![Documentation](https://github.com/mfs4rd/aics_tf_registration/workflows/Documentation/badge.svg)](https://mfs4rd.github.io/aics_tf_registration)
[![Code Coverage](https://codecov.io/gh/mfs4rd/aics_tf_registration/branch/master/graph/badge.svg)](https://codecov.io/gh/mfs4rd/aics_tf_registration)
...
## Quick Start
```python
from aics_tf_registration import Example
...
**Development Head:** `pip install git+https://github.com/mfs4rd/aics_tf_registration.git`

## Documentation
For full package documentation please visit [mfs4rd.github.io/aics_tf_registration](https://mfs4rd.github.io/aics_tf_registration).
...
* Turn your project into a GitHub repository:
  ...
  * After a GitHub repo has been created, run the following commands:
    * `git remote add origin git@github.com:mfs4rd/aics_tf_registration.git`
    * `git push -u origin master`
* Register aics_tf_registration with Codecov:
  * Make an account on [codecov.io](https://codecov.io)
  (Recommended to sign in with GitHub)
  * Select `mfs4rd` and click: `Add new repository`
  * Copy the token provided, go to your [GitHub repository's settings and under the `Secrets` tab](https://github.com/mfs4rd/aics_tf_registration/settings/secrets),
...
generation to work
  ...
  * Go to your [GitHub repository's settings and under the `Secrets` tab](https://github.com/mfs4rd/aics_tf_registration/settings/secrets),
...
* Add branch protections to `master` and `stable`
    * To protect from just anyone pushing to `master` or `stable` (the branches with
    ...
    configurations)
    * Go to your [GitHub repository's settings and under the `Branches` tab](https://github.com/mfs4rd/aics_tf_registration/settings/branches), click `Add rule` and select the
